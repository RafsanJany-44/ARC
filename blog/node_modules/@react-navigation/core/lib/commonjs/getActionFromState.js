...
function getActionFromState(state, options) {
  ...
  if (!(routes.length === 1 || routes.length === 2 && routes[0].name === (normalizedConfig === null || normalizedConfig === void 0 ? void 0 : normalizedConfig.initialRouteName))) {
    return {
      type: 'RESET',
      payload: state
    };
  ...
  while (current) {
    ...
    } else if (routes.length === 2 && routes[0].key === undefined && routes[0].name === ((_config = config) === null || _config === void 0 ? void 0 : _config.initialRouteName)) {
