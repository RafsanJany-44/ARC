...
class ChatBot(object):
    ...
    def __init__(self, name, **kwargs):
        ...
        # TODO what actually search algo does here
    ...
    def get_response(self, statement=None, **kwargs):
        ...
        input_statement = Statement(text=text, conversation=conversation, **kwargs)
        ...
        if not self.read_only:
            self.learn_response(input_statement, response)
            # print("response")
            # self.printstatement(response)
    ...
    def printstatement(self, statement):
        ...
        print("search_text = ", statement.search_text)
        print("conversation = ", statement.conversation)
        print("persona = ", statement.persona)
        print("tags = ", statement.tags)
        print("in_response_to = ", statement.in_response_to)
        print("created_at = ", statement.created_at)
        print("confidence = ", statement.confidence)
        print("storage = ", statement.storage)
        print("search_in_response_to = ", statement.search_in_response_to)

    def learn_response(self, statement, response, previous_statement=None):
        """
        ...
        if not previous_statement:
            ...
            if previous_statement:
                # self.printstatement(previous_statement)
                # print('\n')
        ...
        statement_search_text = self.storage.tagger.get_text_index_string(statement.text)
        statement_save = self.get_preprocessed_statement(
            Statement(
                text=statement.text,
                search_text=statement_search_text,
                in_response_to=previous_statement_text,
                search_in_response_to=self.storage.tagger.get_text_index_string(str(previous_statement_text)),
                conversation=statement.conversation
            )
        )

        # self.printstatement(statement_save)

        # Save the input statement
        return self.storage.create(**statement_save.serialize())
    ...
    def get_latest_response(self, conversation):
        ...
        if latest_statement:
            ...
            # self.printstatement(latest_statement)
